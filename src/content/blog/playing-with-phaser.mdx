...
All in all, I converted the tutorial to TypeScript, loaded the assets locally, fixed the particle emitter, loaded Phaser into a `<div>` tag and added some styles so it would fit on the page and not be too tall. The final source for the tutorial:
