...
After addressing these issues, I was able to get the Phaser game to load inline successfully. I also added an [Astro client directive](https://docs.astro.build/en/reference/directives-reference/#client-directives) to load the scripts only when the client is idle.

import LoadPhaser from "../../components/Phaser/LoadPhaser.astro";

<LoadPhaser client:idle />
